      ...
      <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-900">
        ...
        <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
            ...
            <>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    { id: 'quick-invite',   label: '입주자 초대',          icon: Send,       color: 'orange',  view: VIEWS.INVITE,   tip: '입주자 초대 발송 현황을 확인합니다' },
                    { id: 'quick-charges',  label: '세대별 청구서 조회',  icon: Receipt,    color: 'emerald', view: VIEWS.CHARGES,  tip: '각 세대 청구 내역을 조회합니다' },
                    { id: 'quick-send',     label: '세대별 청구서 발송',  icon: Send,       color: 'rose',    action: true,         tip: '세대에 청구서 문자를 발송합니다' },
          ...
          {view === VIEWS.FEE_ITEMS && (
            <>
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">관리비 항목/금액 설정</h2>
          ...
          {view === VIEWS.SEND && (
            <>
              <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">세대별 청구서 발송 <span className="text-base text-slate-500 dark:text-slate-400 font-normal">2026-03</span></h2>
              ...
              <Button data-tutorial="send-all" onClick={handleAction} className="w-full bg-primary text-white" {...triggerProps('아직 받지 못한 세대에 청구서를 한 번에 발송합니다')}>
