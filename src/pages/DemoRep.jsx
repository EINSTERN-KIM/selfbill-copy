      ...
      <div className="flex-1 overflow-y-auto bg-slate-50">
        ...
        <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
            ...
            <>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    { label: '입주자 초대 현황', icon: Send,        color: 'orange',  view: VIEWS.INVITE },
                    { label: '세대별 청구서 조회', icon: Receipt,    color: 'emerald', view: VIEWS.CHARGES },
          ...
          {view === VIEWS.INVITE && (
            <>
              <div className="flex items-center justify-between">
                ...
                <Button size="sm" onClick={handleAction} className="bg-primary text-white">전체 재발송</Button>
              </div>
              {/* Summary */}
              <div className="grid grid-cols-3 gap-3">
                {[
          ...
          {view === VIEWS.FEE_ITEMS && (
            <>
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold text-slate-900">관리비 항목 설정</h2>
